...
if (localStorage.accaunt) {
    ...
    const noacc1 = document.getElementById("when_no_acc");
    noacc1.style.display = "none";
    ...
    add_card_btn.addEventListener("click", ()=>{
        if (!document.getElementById("card_form")) my_cards.insertAdjacentHTML("beforeend", `
                <form id = "card_form">
                    <span>
        ...
        document.getElementById("card_form").addEventListener("submit", (e)=>{
            ...
            const num1 = formData.get("num");
            const pin = formData.get("pin");
            if (!user.cards.find((val)=>val.num == num1)) {
                ...
                user.balance += 1000;
                document.getElementById("cards").insertAdjacentHTML("beforeend", `<div class = "card_type"><img style = "height:50px" src = "https://w7.pngwing.com/pngs/49/82/png-transparent-credit-card-visa-logo-mastercard-bank-mastercard-blue-text-rectangle.png"><br><label class = "card_balance" id = "a${num1}">1000</label>$<br><label class = "card_number_in_form">${num1}</label></div>`);
                my_balance.innerHTML = user.balance + "$";
                can_be_used.innerHTML = user.balance - instorage + "$";
            } else alert("This card is already added!");
    ...
    add_to_storage.addEventListener("click", (e)=>{
        if (document.getElementById("my_storage")) {
            ...
            my_storage.insertAdjacentHTML("beforeend", `<form id = "storage_form">
                <span style = "display:flex">
            ...
            document.getElementById("storage_form").addEventListener("submit", (e)=>{
                ...
                } else alert("Too much money or wrong card number");
...
} else noacc.style.display = "block";

},{}]},["aJPIF","8ZNvh"], "8ZNvh", "parcelRequire5dc1")

//# sourceMappingURL=bankmainpage.f5c48570.js.map
